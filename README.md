...
> node benchmark/body-100.js
  100 body
   ...
   buffer-base64-camellia-128-cfb      x 37,982 ops/sec ±3.58% m(137 runs sampled)
...
buffer-base64-CAST-cbc              x 19,685 ops/sec ±2.29% (130 runs sampled)
   ...
   buffer-base64-camellia-128-cfb      x 24,831 ops/sec ±2.51[36m% (132 runs sampled)
...
> node benchmark/body-10000.js
  10000 body
   ...
   buffer-base64-camellia-128-cfb      x  6,507 ops/sec ±1.95[36m% (129 runs sampled)
